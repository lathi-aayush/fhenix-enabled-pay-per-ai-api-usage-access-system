...
const TEMPLATES = [
  ...
  },
  {
    ...
    chain: ["text"],
    prompt:
      "Write an investor pitch deck narrative for Sentinel — a pay-per-use AI API gateway on Sepolia. Include problem, solution, market, business model, traction, and ask. Format as slide-by-slide outlines",
  },
  {
