...
const marketplaceSteps = [
  ...
  },
  {
    ...
    desc: "Send a request. Our backend meters every token. Each call deducts ETH directly to the creator's wallet — no middleman.",
    pill: "Step 3",
...
function LiveApiDemo({ visible }) {
  ...
  const mockLines = [
    ...
    { t: 1200, txt: '← 200 OK  |  tokens: 842  |  cost: 0.0012 ETH', c: "text-emerald-400" },
